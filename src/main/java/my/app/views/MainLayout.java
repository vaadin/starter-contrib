...
import my.app.views.masterdetailbook.MasterDetailBookView;
import my.app.views.masterdetailperson.MasterDetailPersonView;
import my.app.views.publicview.PublicviewView;
import my.app.views.userroleonly.UserroleonlyView;
...
public class MainLayout extends AppLayout {
    ...
    private void addDrawerContent() {
        H1 appName = new H1("test-entities-auth");
